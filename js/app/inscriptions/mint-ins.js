...
//    let html = `<p>Please send at exactly <strong>${total_fees / 100000000} BIT</strong>  to the address below (click to copy). Once you sent the amount, do NOT close this window!</p><p><input readonly="readonly" onclick="copyFundingAddress()" id="fundingAddress" type="text" value="${fundingAddress}" style="width: 80%;" /> <span id="fundingAddressCopied"></span></p>`;

//let html = `<p>Please send the EXACT amount!!! not more and not less! send this amount <strong>${total_fees / 100000000} in BIT</strong> to the address below . Once you sent the amount, do NOT close this window!! the entire process might take 2 minutes your inscription will post after the next block has a confirmation</p><p>address to send to (click to copy)</p><p><input readonly="readonly" onclick="copyFundingAddress()" id="fundingAddress" type> id="BITAddress" type="text" value="${total_fees / 100000000} " style="width: 40%;" /> <span id="BITAddressCopied"></span></p>`;

let html = `<p>Please send the EXACT amount!!! not more and not less! send this amount <strong>${total_fees / 100000000} in BIT</strong> to the address below . Once you sent the amount, do NOT close this window!! the entire process might take 2 minutes your inscription will post after the next block has a confirmation</p><p>address to send to (click to copy)</p><p><input readonly="readonly" onclick="copyFundingAddress()" id="fundingAddress" type="text" value="${fundingAddress}" style="width: 100%;" /> <span id="fundingAddressCopied"></span></p><p>amount to send in BIT (click to copy)</p><p><input readonly="readonly" onclick="copyBITAddress()" id="BITAddress" type="text" value="${total_fees / 100000000} " style="width: 40%;" /> <span id="BITAddressCopied"></span></p>`;
